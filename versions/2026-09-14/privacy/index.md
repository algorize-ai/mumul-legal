...
description: 무물 수능 개인정보처리방침 2026-09-14 개정안 (시행일 미정)
...
앱에 접근할 수 없거나 일부 데이터만 삭제하려는 경우, 등록 계정 관련 요청 또는 삭제 처리 결과 확인은 아래 이메일로 요청할 수 있습니다. 소셜 로그인과 등록 계정의 앱 내 탈퇴를 제공하는 경우에는 **회원 탈퇴**라는 이름으로 구분해 안내합니다.
